...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, performFetchWithCompletionHandler completionHandler: @escaping (UIBackgroundFetchResult) -> Void) {
        ...
        let entity = NSEntityDescription.entity(forEntityName: "BatteryEvents", in: context)
        let newEvent = NSManagedObject(entity: entity!, insertInto: context)
        
        newEvent.setValue(level, forKey: "percentage")
        newEvent.setValue(time, forKey: "date")
        newEvent.setValue(false, forKey: "synced")
